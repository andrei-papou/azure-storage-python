...
# --------------------------------------------------------------------------
from azure_async.table._error import (
...
class TableBatch(object):
    '''
    This is the class that is used for batch operation for azure_async table service.
    ...
    def insert_entity(self, entity):
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.insert_entity` for more
    ...
    def update_entity(self, entity, if_match='*'):
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.update_entity` for more
    ...
    def merge_entity(self, entity, if_match='*'):
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.merge_entity` for more
    ...
    def delete_entity(self, partition_key, row_key,
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.delete_entity` for more
    ...
    def insert_or_replace_entity(self, entity):
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.insert_or_replace_entity` for more
    ...
    def insert_or_merge_entity(self, entity):
        ...
        :func:`~azure.azure_async.table.tableservice.TableService.insert_or_merge_entity` for more
