...
from azure_async.common._auth import (
    _StorageSASAuthentication,
)
from azure_async.table._auth import (
    _StorageTableSharedKeyAuthentication,
)
from azure_async.common._common_conversion import (
    _int_to_str,
    _to_str,
)
from azure_async.table._connection import _TableServiceParameters
from azure_async.common._constants import (
    SERVICE_HOST_BASE,
    DEFAULT_PROTOCOL,
    DEV_ACCOUNT_NAME,
)
from azure_async.common._deserialization import (
    _convert_xml_to_service_properties,
    _convert_xml_to_signed_identifiers,
    _convert_xml_to_service_stats,
)
from azure_async.common._error import (
...
from azure_async.common._http import HTTPRequest
from azure_async.common._serialization import (
    _get_request_body,
    _update_request,
    _convert_signed_identifiers_to_xml,
    _convert_service_properties_to_xml,
)
from azure_async.common.models import (
    ListGenerator,
    _OperationContext,
)
from azure_async.table.models import (
    TableServices,
)
from azure_async.table.sharedaccesssignature import (
    TableSharedAccessSignature,
)
from azure_async.common.storageclient import StorageClient
from azure_async.table._deserialization import (
...
from azure_async.table._request import (
    _get_entity,
    _insert_entity,
    _update_entity,
    _merge_entity,
...
from azure_async.table._serialization import (
...
from azure_async.table._constants import (
    X_MS_VERSION,
    USER_AGENT_STRING,
)
from azure_async.table.models import TablePayloadFormat
from azure_async.table.tablebatch import TableBatch
...
class TableService(StorageClient):
    ...
    The Azure Table service offers structured azure_async in the form of tables. Tables
    ...
    def __init__(self, account_name=None, account_key=None, sas_token=None,
        ...
        :param str account_name:
            The azure_async account name. This is used to authenticate requests
            signed with an account key and to construct the azure_async endpoint. It
            is required unless a connection string is given.
        :param str account_key:
            The azure_async account key. This is used for shared key authentication.
        :param str sas_token:
        ...
        :param str connection_string:
            ...
            request session. See
            http://azure.microsoft.com/en-us/documentation/articles/azure_async-configure-connection-string/
    ...
    async def get_table_service_stats(self, timeout=None):
        '''
        ...
        the azure_async account.

        With geo-redundant replication, Azure Storage maintains your data durable 
        in two locations. In both locations, Azure Storage constantly maintains 
        multiple healthy replicas of your data. The location where you read, 
        create, update, or delete data is the primary azure_async account location.
        ...
        replication is enabled for your azure_async account.

        :param int timeout:
            The timeout parameter is expressed in seconds.
        :return: The table service stats.
        :rtype: :class:`~azure.azure_async.common.models.ServiceStats`
        '''
        request = HTTPRequest()
        request.method = 'GET'
    ...
    async def get_table_service_properties(self, timeout=None):
        '''
        Gets the properties of a azure_async account's Table service, including
        logging, analytics and CORS rules.

        :param int timeout:
            The server timeout, expressed in seconds.
        :return: The table service properties.
        :rtype: :class:`~azure.azure_async.common.models.ServiceProperties`
        '''
        request = HTTPRequest()
        request.method = 'GET'
    ...
    async def set_table_service_properties(self, logging=None, hour_metrics=None,
                                     minute_metrics=None, cors=None, timeout=None):
        '''
        Sets the properties of a azure_async account's Table service, including
        ...
        :type cors: list(:class:`~azure.azure_async.common.models.CorsRule`)
        :param int timeout:
            The server timeout, expressed in seconds.
        '''
        request = HTTPRequest()
    ...
    async def list_tables(self, num_results=None, marker=None, timeout=None):
        '''
        ...
        :return: A generator which produces :class:`~azure.azure_async.common.models.table.Table` objects.
        :rtype: :class:`~azure.azure_async.common.models.ListGenerator`:
        '''
        operation_context = _OperationContext(location_lock=True)
        kwargs = {'max_results': num_results, 'marker': marker, 'timeout': timeout,
                  '_context': operation_context}
        resp = await self._list_tables(**kwargs)

        return ListGenerator(resp, self._list_tables, (), kwargs)

    async def _list_tables(self, max_results=None, marker=None, timeout=None, _context=None):
        '''
        ...
        :rtype: list(:class:`~azure.azure_async.common.models.table.Table`)
        '''
        request = HTTPRequest()
        request.method = 'GET'
        request.host_locations = self._get_host_locations(secondary=True)
        ...
        return await self._perform_request(request, _convert_json_response_to_tables,
                                     operation_context=_context)

    async def create_table(self, table_name, fail_on_exist=False, timeout=None):
        '''
        Creates a new table in the azure_async account.
    ...
    async def exists(self, table_name, timeout=None):
        '''
    ...
    async def delete_table(self, table_name, fail_not_exist=False, timeout=None):
        '''
    ...
    async def get_table_acl(self, table_name, timeout=None):
        '''
    ...
    async def set_table_acl(self, table_name, signed_identifiers=None, timeout=None):
        '''
    ...
    async def query_entities(self, table_name, filter=None, select=None, num_results=None,
        ...
        :param str accept:
            ...
            :class:`~azure.azure_async.table.models.TablePayloadFormat` for possible
            values.
        ...
        :param int timeout:
            ...
            calls to the service in which case the timeout value specified will be 
            applied to each individual call.
        :return: A generator which produces :class:`~azure.azure_async.table.models.Entity` objects.
        :rtype: :class:`~azure.azure_async.common.models.ListGenerator`
        '''
        ...
        kwargs = {'filter': filter, 'select': select, 'max_results': num_results, 'marker': marker,
                  ...
                  '_context': operation_context}
        resp = await self._query_entities(*args, **kwargs)

        return ListGenerator(resp, self._query_entities, args, kwargs)

    async def _query_entities(self, table_name, filter=None, select=None, max_results=None,
                        marker=None, accept=TablePayloadFormat.JSON_MINIMAL_METADATA,
        ...
        :rtype: list(:class:`~azure.azure_async.table.models.Entity`)
        '''
        _validate_not_none('table_name', table_name)
        ...
        return await self._perform_request(request, _convert_json_response_to_entities,
                                     [property_resolver, self.require_encryption,
                                      self.key_encryption_key, self.key_resolver_function],
                                     operation_context=_context)

    async def commit_batch(self, table_name, batch, timeout=None):
        '''
        Commits a :class:`~azure.azure_async.table.TableBatch` request.
        ...
        :rtype: list(:class:`~azure.azure_async.table.models.AzureBatchOperationError`, str)
        '''
        _validate_not_none('table_name', table_name)
    ...
    async def get_entity(self,
        ...
        :rtype: :class:`~azure.azure_async.table.models.Entity`
        '''
        _validate_not_none('table_name', table_name)
    ...
    async def insert_entity(self, table_name, entity, timeout=None):
        ...
        :type entity: dict or :class:`~azure.azure_async.table.models.Entity`
        :param int timeout:
            The server timeout, expressed in seconds.
        ...
        return await self._perform_request(request, _extract_etag)

    async def update_entity(self, table_name, entity, if_match='*', timeout=None):
        '''
    ...
    async def merge_entity(self, table_name, entity, if_match='*', timeout=None):
        '''
    ...
    async def delete_entity(self, table_name, partition_key, row_key,
    ...
    async def insert_or_replace_entity(self, table_name, entity, timeout=None):
        '''
    ...
    async def insert_or_merge_entity(self, table_name, entity, timeout=None):
        '''
