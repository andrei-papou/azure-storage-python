...
class TablePermissions(object):
    '''
    TablePermissions class to be used with the :func:`~azure.azure_async.table.tableservice.TableService.generate_table_shared_access_signature`
    method and for the AccessPolicies used with :func:`~azure.azure_async.table.tableservice.TableService.set_table_acl`.
