...
class QueuePermissions(object):
    '''
    QueuePermissions class to be used with :func:`~azure.azure_async.queue.queueservice.QueueService.generate_queue_shared_access_signature`
    method and for the AccessPolicies used with :func:`~azure.azure_async.queue.queueservice.QueueService.set_queue_acl`.
