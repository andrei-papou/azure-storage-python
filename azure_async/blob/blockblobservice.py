...
class BlockBlobService(BaseBlobService):
    ...
    def put_block_list(
        ...
        :type block_list: list(:class:`~azure.azure_async.blob.models.BlobBlock`)
        ...
        :param bool validate_content:
            If true, calculates an MD5 hash of the block list content. The azure_async
    ...
    def get_block_list(self, container_name, blob_name, snapshot=None,
        ...
        :rtype: :class:`~azure.azure_async.blob.models.BlobBlockList`
        '''
    ...
    async def set_standard_blob_tier(
        ...
        '''
        Sets the block blob tiers on the blob. This API is only supported for block blobs on standard azure_async accounts.
        ...
        :param StandardBlobTier standard_blob_tier:
            ...
            this is only applicable to block blobs on standard azure_async accounts.
        :param int timeout:
            The timeout parameter is expressed in seconds. This method may make
            multiple calls to the Azure service and the timeout will apply to
            each call individually.
    ...
    async def _put_blob(self, container_name, blob_name, blob, content_settings=None,
        ...
        :param metadata:
            Name-value pairs associated with the blob as metadata.
        :param bool validate_content:
            If true, calculates an MD5 hash of the blob content. The azure_async
            service checks the hash of the content that has arrived
            with the hash that was sent. This is primarily valuable for detecting
            bitflips on the wire if using http instead of https as https (the default)
            will already validate. Note that this MD5 hash is not stored with the
