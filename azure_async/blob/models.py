...
# --------------------------------------------------------------------------
from azure_async.common._common_conversion import _to_str
...
class BlobProperties(object):
    ...
    :ivar ~azure.azure_async.blob.models.CopyProperties copy:
        Stores all the copy properties for the blob.
    :ivar ~azure.azure_async.blob.models.ContentSettings content_settings:
        Stores all the content settings for the blob.
    :ivar ~azure.azure_async.blob.models.LeaseProperties lease:
    ...
    :ivar StandardBlobTier blob_tier:
        ...
        for storing data that is accessed frequently. The cool azure_async tier
...
class BlobPrefix(object):
    ...
    :func:`~azure.azure_async.blob.baseblobservice.BaseBlobService.list_blobs` is
...
class BlobBlockList(object):
    ...
    :vartype committed_blocks: list(:class:`~azure.azure_async.blob.models.BlobBlock`)
    :ivar uncommitted_blocks:
        List of uncommitted blocks.
    :vartype uncommitted_blocks: list(:class:`~azure.azure_async.blob.models.BlobBlock`)
    '''
...
class PublicAccess(object):
    ...
    Clients cannot enumerate the containers within the azure_async account as well as the blobs within the container.
    '''
    ...
    within the azure_async account.
    '''
...
class Include(object):
    ...
    :ivar ~azure.azure_async.blob.models.Include Include.COPY:
        Specifies that metadata related to any current or previous Copy Blob operation 
        should be included in the response.
    :ivar ~azure.azure_async.blob.models.Include Include.METADATA:
        Specifies that metadata be returned in the response.
    :ivar ~azure.azure_async.blob.models.Include Include.SNAPSHOTS:
        Specifies that snapshots should be included in the enumeration.
    :ivar ~azure.azure_async.blob.models.Include Include.UNCOMMITTED_BLOBS:
...
class BlobPermissions(object):
    ...
    :func:`~azure.azure_async.blob.baseblobservice.BaseBlobService.generate_blob_shared_access_signature` API.
...
class ContainerPermissions(object):
    '''
    ContainerPermissions class to be used with :func:`~azure.azure_async.blob.baseblobservice.BaseBlobService.generate_container_shared_access_signature`
    API and for the AccessPolicies used with :func:`~azure.azure_async.blob.baseblobservice.BaseBlobService.set_container_acl`.
...
class PremiumPageBlobTier(object):
    ...
    blobs on premium azure_async accounts.
    Please take a look at https://docs.microsoft.com/en-us/azure/azure_async/azure_async-premium-azure_async#scalability-and-performance-targets
...
class StandardBlobTier(object):
    '''
    Specifies the blob tier to set the blob to. This is only applicable for block blobs on standard azure_async accounts.
    '''
