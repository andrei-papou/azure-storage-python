...
from azure_async.common._connection import _ServiceParameters
...
class BaseBlobService(StorageClient):
    ...
    The Blob service offers the following three resources: the azure_async account,
    containers, and blobs. Within your azure_async account, containers provide a
    ...
    async def create_container(self, container_name, metadata=None,
        ...
        :param ~azure.azure_async.blob.models.PublicAccess public_access:
    ...
    async def get_container_properties(self, container_name, lease_id=None, timeout=None):
        ...
        :rtype: :class:`~azure.azure_async.blob.models.Container`
        '''
        _validate_not_none('container_name', container_name)
        request = HTTPRequest()
        request.method = 'GET'
    ...
    async def get_container_acl(self, container_name, lease_id=None, timeout=None):
        ...
        :return: A dictionary of access policies associated with the container. dict of str to
            :class:`azure.azure_async.common.models.AccessPolicy` and a public_access property
    ...
    async def list_blobs(self, container_name, prefix=None, num_results=None, include=None,
        ...
        :param ~azure.azure_async.blob.models.Include include:
            Specifies one or more additional datasets to include in the response.
        :param str delimiter:
            When the request includes this parameter, the operation
            returns a :class:`~azure.azure_async.blob.models.BlobPrefix` element in the
    ...
    async def _list_blobs(self, container_name, prefix=None, marker=None,
        ...
        :param int max_results:
            Specifies the maximum number of blobs to return,
            including all :class:`~azure.azure_async.blob.models.BlobPrefix` elements. If the request does not specify
        ...
        :param str delimiter:
            When the request includes this parameter, the operation
            returns a :class:`~azure.azure_async.blob.models.BlobPrefix` element in the response body that acts as a
    ...
    async def set_blob_service_properties(
        ...
        '''
        Sets the properties of a azure_async account's Blob service, including
    ...
    async def get_blob_service_properties(self, timeout=None):
        '''
        Gets the properties of a azure_async account's Blob service, including
        ...
        :rtype:
            :class:`~azure.azure_async.common.models.ServiceProperties` with an attached
    ...
    async def get_blob_properties(
        ...
        Returns :class:`~azure.azure_async.blob.models.Blob`
        with :class:`~azure.azure_async.blob.models.BlobProperties` and a metadata dict.
        ...
        :rtype: :class:`~azure.azure_async.blob.models.Blob`
        '''
        _validate_not_none('container_name', container_name)
        _validate_not_none('blob_name', blob_name)
        request = HTTPRequest()
    ...
    async def get_blob_to_path(
        ...
        notifications. Returns an instance of :class:`~azure.azure_async.blob.models.Blob` with
    ...
    async def get_blob_to_bytes(
        ...
        progress notifications. Returns an instance of :class:`~azure.azure_async.blob.models.Blob` with
    ...
    async def copy_blob(self, container_name, blob_name, copy_source,
        ...
        :rtype: :class:`~azure.azure_async.blob.models.CopyProperties`
        '''
    ...
    async def delete_blob(self, container_name, blob_name, snapshot=None,
        ...
        :param str lease_id:
            Required if the blob has an active lease.
        :param ~azure.azure_async.blob.models.DeleteSnapshot delete_snapshots:
